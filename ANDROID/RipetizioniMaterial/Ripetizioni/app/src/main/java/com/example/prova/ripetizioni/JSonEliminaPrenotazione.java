...
public class JSonEliminaPrenotazione {
    private final String LOG_TAG = JSonLogin.class.getSimpleName();
    public class EliminaPrenTask extends AsyncTask<String, String, String> {



        private String deleteDataFromJson(String forecastJsonStr)
                throws JSONException {

            // These is a name of the JSON objects that need to be extracted.
            final String OWM_LOGGED = "eliminato";
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                return deleteDataFromJson(forecastJsonStr);
