        ...
        <nav style="background-color: #475369; " class="navbar navbar-expand-lg navbar-light">
            ...
            <div style="background-color: #475369" class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto" >
                    ...
                    <li class="nav-item"style="background-color: #475369; color:#be9e21;">
                        <a style="color:#be9e21;" class="nav-link" href="<%= request.getContextPath()%>/Controller?toDo=prenota_a" target="" >Nuova Prenotazione</a>
                    </li>
                </ul>
            </div>
        </nav>
        <span class="login100-form-title" style="margin: auto; padding-top: 1%; margin-bottom: 0; padding-bottom: 1%;">
            GESTIONE CORSI
        </span>
        <form>
